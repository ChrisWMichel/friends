<template>
    <div class="mb-4 relative">
       ...
       <!-- <a href="#" class="bg-gray-900 w-8 h-8 rounded-full top-0 right-0 mt-3 mr-3 flex items-center justify-center" >-->
        <a href="#" class="closeBtn rounded-full" @click.prevent="$emit('removed', video)" >
